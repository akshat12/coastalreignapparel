...
function x_global_admin_styles() {

  $addons_font_url = add_query_arg( array( 'family' => 'Lato:300', 'text' => 'X' ), '//fonts.googleapis.com/css' );

  ?>

  <style type="text/css" id="x-global-admin-css">

    /*
    // Addons.
    */

    @import url(<?php echo $addons_font_url; ?>);
...
add_action( 'admin_head', 'x_global_admin_styles' );